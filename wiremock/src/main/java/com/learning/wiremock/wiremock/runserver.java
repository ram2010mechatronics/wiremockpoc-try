...
public class runserver {
    ...
    public static void main(final String[] args) {
        ...
        args2[args.length + 3] = "com.learning.wiremock.wiremock.wiremock_ext";
        args2[args.length + 4] = "--root-dir";
        args2[args.length + 5] = "D:\\WireMock\\wire-mock-master\\wiremockpoc-try\\wiremock\\src\\test\\resources\\csv";
