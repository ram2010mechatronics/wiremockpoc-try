...
public class BodyTransformers extends ResponseDefinitionTransformer {
    ...
    private CharSequence getValue(String group, @SuppressWarnings("rawtypes") Map requestObject) {
